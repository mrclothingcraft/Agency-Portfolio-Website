        ...
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            ...
            <a
              ...
              className="w-full sm:w-auto px-6 py-3.5 rounded-full bg-[#0A0E1A] hover:bg-[#161F36] text-[#9AA3C2] hover:text-[#F3F5FA] border border-[#1E2945] text-xs font-semibold tracking-wider flex items-center justify-center gap-2 transition-all"
              onMouseEnter={() => setCursor('link', 'Chat')}
              onMouseLeave={resetCursor}
            >
              <MessageSquare className="h-3.5 w-3.5 text-[#17B4E0]" />
